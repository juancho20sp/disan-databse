...
EXECUTE PKG_SPECIALITY.ADD_SPECIALTY('Nueva especialidad');
...
SELECT PA_DOCTOR.READ_APPOINTMENTS('CC', 1458759875) FROM DUAL;

-- AGREGAR ENFERMERO A LA CITA
SELECT PA_DOCTOR.READ_NURSE FROM DUAL;
EXECUTE PA_DOCTOR.ADD_APPOINTMENT_NURSE('CC', 4252609306, 2);
--SELECT PKG_NURSE.READ_APPOINTMENTS('CC', 4252609306) FROM DUAL;

-- AÑADIR DIAGNÓSTICO
EXECUTE PA_DOCTOR.ADD_DIAGNOSIS(2, 'El médico añadió un diagnóstico');
...
EXECUTE PA_DOCTOR.ADD_MANAGEMENT_PLAN(13, 2);

-- FINALIZAR CITA
EXECUTE PA_DOCTOR.FINISH_APPOINTMENT(2);
...
EXECUTE PA_DOCTOR.ADD_MANAGEMENT_PLAN(11, 14);
