...
CREATE OR REPLACE TRIGGER UPDATE_DIVISION
BEFORE UPDATE ON Division 
FOR EACH ROW
BEGIN
  IF :new.commander IS NULL OR :new.militaryForce IS NULL THEN
    RAISE_APPLICATION_ERROR(-20002, 'TODOS LOS DATOS DE LA DIVISIÓN SON OBLIGATORIOS');
  END IF;
END;
