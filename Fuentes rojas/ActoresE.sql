...
CREATE OR REPLACE PACKAGE PA_DOCTOR IS
    -- READ SPECIFIC EXAMS
    FUNCTION READ_SPEC_EXAMS(xIdExam IN NUMBER);
    ...
    FUNCTION ADD_APPOINTMENT_DOCTOR(xDocType IN VARCHAR, xDocNum IN NUMBER, xIdAppointment IN NUMBER);

    -- ADD DIAGNOSIS
    FUNCTION ADD_DIAGNOSIS(xIdAppointment IN NUMBER, xDiagnosis IN VARCHAR);
    ...
    -- READ SPECIFIC NURSE
    FUNCTION READ_SPECIFIC_NURSE(xDocType IN VARCHAR, xDocNum IN NUMBER);

   -- READ NURSE
   FUNCTION READ_NURSE RETURN SYS_REFCURSOR;

   -- READ SPECIFIC PATIENT
    FUNCTION READ_SPECIFIC_PATIENT(xDocType IN VARCHAR, xDocNum IN NUMBER);
...
CREATE OR REPLACE PACKAGE PA_NURSE IS
    ...
    FUNCTION READ_NURSE_PROCEDURES(xDocType IN VARCHAR, xDocNum IN NUMBER);

    -- ADD PROCEDURE NURSE
    PROCEDURE ADD_PROCEDURE_NURSE(xDocType IN VARCHAR, xDocNum IN NUMBER, xIdProcedure IN VARCHAR);

    -- READ DOCTOR PROCEDURE
    FUNCTION READ_DOCTOR_PROCEDURES(xDocType IN VARCHAR, xDocNum IN NUMBER);
...
CREATE OR REPLACE PACKAGE PA_ADMIN IS
    ...
    -- APPOINTMENT DOCTOR
    FUNCTION READ_DOC_APPOINTMENTS(xDocType : VARCHAR, xDocNum : NUMBER);

    -- APPOINTMENT NURSE
    FUNCTION READ_NUR_APPOINTMENTS(xDocType : VARCHAR, xDocNum : NUMBER);

    -- APPOINTMENT PATIENT
    FUNCTION READ_PAT_APPOINTMENTS(xDocType : VARCHAR, xDocNum : NUMBER);
    ...
    FUNCTION READ_SPECIFIC_DOCTOR(xDocType : VARCHAR, xDocNum : NUMBER);
    ...
    -- READ CLINICAL HISTORY
    FUNCTION READ_CLINICAL_HISTORY(xDocType : VARCHAR, xDocNum : NUMBER);

    -- READ PATIENT BACKGROUNDS
    FUNCTION READ_PATIENT_BACKGROUNDS(xIdClinicalHistory : NUMBER);
    ...
    -- READ EXAMS NURSE
    FUNCTION READ_EXAM_NURSE(xIdExam : NUMBER, xDocType : VARCHAR, xDocNum : NUMBER);
